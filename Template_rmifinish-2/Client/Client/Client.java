	...
	public void execute(Command cmd, Vector<String> arguments) throws RemoteException, NumberFormatException
	{
		switch (cmd)
		{
			...
			case Bundle: {
				...
				System.out.println("-Car reserve stats: " + arguments.elementAt(arguments.size()-2));
				System.out.println("-Room Location: " + arguments.elementAt(arguments.size()-3));
				System.out.println("-Room reserve stats: " + arguments.elementAt(arguments.size()-1));
			...
			case Start:{
				if(arguments.size()==2) {
					System.out.println(m_resourceManager.start(Integer.valueOf(arguments.elementAt(1))));
				}else {
					System.out.println(m_resourceManager.start());
			...
			case CrashCar:{
				System.out.println("in crash car");
				
				m_resourceManager.setCrashMode("c", toInt(arguments.elementAt(1)));
				break;
			}
			case CrashFlight:{
				System.out.println("in crash flight");
				
				m_resourceManager.setCrashMode("f", toInt(arguments.elementAt(1)));
				break;
			}
			case CrashRoom:{
				System.out.println("in crash room");
				
				m_resourceManager.setCrashMode("r", toInt(arguments.elementAt(1)));
				break;
			}
			case CrashMid:{
				System.out.println("in crash mid");
				
				m_resourceManager.setCrashMode("m", toInt(arguments.elementAt(1)));
				break;
			}
			case ResetCrash:{
				System.out.println("in reset crash");
