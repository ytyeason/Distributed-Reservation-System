...
public class Customer extends RMItem
{
	...
	private HashMap<String, ArrayList<Integer>> oldPrices = new HashMap<>();
	...
	public void reserve(String key, String location, int price)
	{
		...
		else
		{
			...
			oldPrices.get(key+location).add(price);
		}
	...
	public void unReserve(String key, String location) {
		...
		reservedItem.setCount(reservedItem.getCount() - 1);
		int oldPrice = oldPrices.get(key+location).get(oldPrices.size()-1);
