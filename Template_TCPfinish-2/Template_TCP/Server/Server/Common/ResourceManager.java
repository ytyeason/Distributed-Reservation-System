...
public class ResourceManager implements IResourceManager
{
	...
	public int queryLeastItem(int xid, int customerID) throws RemoteException
	{
		Trace.info("RM::queryLeastItem(" + xid + ", " + customerID + ") called");
		Customer customer = (Customer)readData(xid, Customer.getKey(customerID));
		if (customer == null)
		{
			Trace.warn("RM::queryLeastItem(" + xid + ", " + customerID + ") failed--customer doesn't exist");
			// NOTE: don't change this--WC counts on this value indicating a customer does not exist...
			return 0;
		}
		else
		{
			Trace.info("RM::queryLeastItem(" + xid + ", " + customerID + ")");
	...
	public boolean deleteCustomer(int xid, int customerID) throws RemoteException
	{
		...
		{        
			ids.remove(new Integer(customerID));
